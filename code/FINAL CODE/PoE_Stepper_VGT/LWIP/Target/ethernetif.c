...
/* USER CODE BEGIN 2 */
__attribute__ ((section(".RxDecripSection"), used)) ETH_DMADescTypeDef DMARxDscrTab[ETH_RXBUFNB] __ALIGN_END;
__attribute__ ((section(".TxDecripSection"), used)) ETH_DMADescTypeDef DMATxDscrTab[ETH_TXBUFNB] __ALIGN_END;
